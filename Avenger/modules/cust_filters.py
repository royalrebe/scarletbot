...
from Avenger import dispatcher, LOGGER, DRAGONS
...
from Avenger.modules.helper_funcs.extraction import extract_text
from Avenger.modules.helper_funcs.filters import CustomFilters
from Avenger.modules.helper_funcs.misc import build_keyboard_parser
from Avenger.modules.helper_funcs.msg_types import get_filter_type
...
from Avenger.modules.sql import cust_filters_sql as sql
...
def __stats__():
    return "≛≛ <b><b>ᴛᴏᴛᴀʟ ꜰɪʟᴛᴇʀ :</b></b> {}".format(sql.num_filters())
