...
from Avenger.modules.sql import antiflood_sql as sql
        ...
        if val in ["off", "no", "0"]:
            ...
            if conn:
                text = message.reply_text(
                    "❌ 𝐀𝐧𝐭𝐢-𝐟𝐥𝐨𝐨𝐝 𝐡𝐚𝐬 𝐛𝐞𝐞𝐧 𝐝𝐢𝐬𝐚𝐛𝐥𝐞𝐝 𝐢𝐧 {}.".format(chat_name),
                )
            else:
                text = message.reply_text("❌ 𝐀𝐧𝐭𝐢-𝐟𝐥𝐨𝐨𝐝 𝐡𝐚𝐬 𝐛𝐞𝐞𝐧 𝐝𝐢𝐬𝐚𝐛𝐥𝐞𝐝")
...
def flood(update, context):
    ...
    if limit == 0:
        if conn:
            ...
            text = msg.reply_text("𝐀𝐧𝐭𝐢-𝐟𝐥𝐨𝐨𝐝 𝐒𝐲𝐬𝐭𝐞𝐦\n\n𝐒𝐭𝐚𝐭𝐮𝐬 : ❌ ᴅɪꜱᴀʙʟᴇ")
    elif conn:
        text = msg.reply_text(
