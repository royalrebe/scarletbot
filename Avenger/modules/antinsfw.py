...
**————————————————————**
__Powered By @BHOOT_UPDATE__.
"""
    )


@pbot.on_message(filters.command(["nsfwscan", f"nsfwscan@mrsScarlett_bot"]))
@capture_err
...
@pbot.on_message(
    filters.command(["antinsfw", f"antinsfw@mrsScarlett_bot"]) & ~filters.private
)
