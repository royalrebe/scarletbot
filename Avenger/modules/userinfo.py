...
def info(update: Update, context: CallbackContext):
    ...
    rep = message.reply_text("<b>ɢᴇᴛᴛɪɴɢ ɪɴꜰᴏʀᴍᴀᴛɪᴏɴ...</b>", parse_mode=ParseMode.HTML)
    ...
    if user.username:
        text += f"\n✪ <b>ᴜꜱᴇʀɴᴀᴍᴇ:</b> @{html.escape(user.username)}"

    text += f"\n✪ <b>ᴜꜱᴇʀ ʟɪɴᴋ:</b> {mention_html(user.id, 'link')}"

    if chat.type != "private" and user_id != bot.id:
        _stext = "\n✪ <b>ᴘʀᴇꜱᴇɴᴄᴇ:</b> <code>{}</code>"
    ...
    if user.id == OWNER_ID:
        ...
        disaster_level_present = True
    elif user.id == 412094015:
        text += "\n\nOwner Of Bot. Queen Of @mkspali."
        disaster_level_present = True
                    ...
                    [
                        [
                            InlineKeyboardButton(
                                ...
                                url="t.me/mrsScarlett_bot?startgroup=new",
                            ),
                        ],
                    ]
                ),
    ...
    update.effective_message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        text="ᴜᴘᴅᴀᴛᴇꜱ", url=f"https://t.me/BHOOT_UPDATE"
                    ),
                    InlineKeyboardButton(
                        text="ꜱᴜᴘᴘᴏʀᴛ", url=f"https://t.me/BHOOT_SUPPORT"
                    ),
                ],
            ]
        ),
