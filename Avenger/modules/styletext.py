...
/bubble <some text or reply with text> : For Change the font
/fbubble <some text or reply with text> : For Change the font
/square <some text or reply with text> : For Change the font
/fsquare <some text or reply with text> : For Change the font
/blue <some text or reply with text> : For Change the font
