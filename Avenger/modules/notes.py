...
from Avenger.ex_utils.msg_types import Types, get_note_type
from Avenger.ex_utils.string import (
    build_keyboard,
            ...
            reply_markup=ikb(
                [
                    [
                        (
                            "Click Me!",
                            f"https://t.me/mrsScarlett_bot?start=note_{m.chat.id}_{note_hash}",
                            "url",
                        ),
                    ],
                ],
...
@app.on_message(command(["notes", "notes@mrsScarlett_bot"]) & filters.group & ~filters.bot)
        ...
        pm_kb = ikb(
            [
                [
                    (
                        "All Notes",
                        f"https://t.me/mrsScarlett_bot?start=notes_{m.chat.id}",
                        "url",
                    ),
                ],
            ],
...
@app.on_message(command(["clearall", "clearall@mrsScarlett_bot"]) & owner_filter & ~filters.bot)
