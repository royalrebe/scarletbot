...
def gban(update: Update, context: CallbackContext):
    ...
    try:
        bot.send_message(
            ...
            f"</b>Appeal Chat:</b> @BHOOT_SUPPORT",
            parse_mode=ParseMode.HTML,
        )
    except:
...
def __stats__():
    return f"≛≛ <b><b>ᴛᴏᴛᴀʟ ɢʙᴀɴꜱ :</b></b> {gban_db.num_gbanned_users()} "
...
__help__ = """
/gbanstat [On | Off] : First Turn On gbanstat then Gban any user
/gban <Reply with user Id / Reply with User's Message> : For Globally Ban a User
